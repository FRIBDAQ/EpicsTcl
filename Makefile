...
ACLOCAL = ${SHELL} /fox/EpicsTcl/config/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /fox/EpicsTcl/config/missing autoconf
AUTOHEADER = ${SHELL} /fox/EpicsTcl/config/missing autoheader
AUTOMAKE = ${SHELL} /fox/EpicsTcl/config/missing automake-1.16
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /fox/EpicsTcl/config/missing makeinfo
...
X_LIBS = 
X_PRE_LIBS =  -lSM -lICE
abs_builddir = /fox/EpicsTcl
abs_srcdir = /fox/EpicsTcl
abs_top_builddir = /fox/EpicsTcl
abs_top_srcdir = /fox/EpicsTcl
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /fox/EpicsTcl/config/install-sh
...
INCLUDES = -pthread  -I/usr/include/tcl8.6  -I/usr/include/tcl8.6 -DEPICS_BIN="\"/usr/opt/epics/bin/linux-x86_64\"" -I/usr/opt/epics/include -I/usr/opt/epics/include/os/Linux -I/usr/opt/epics/include/compiler/gcc \
